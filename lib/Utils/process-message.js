...
export const cleanMessage = (message, meId, meLid) => {
    ...
    function normaliseKey(msgKey) {
        ...
        if (!message.key.fromMe) {
            ...
            // In a 1-on-1 chat, `participant` is undefined, so fall back to `remoteJid`.
            ...
            msgKey.fromMe =
                areJidsSameUser(originalAuthor, meId) ||
                    areJidsSameUser(originalAuthor, meLid); // [wileys-v10-process-nested-key]
...
// [wileys-v10-process-msg]
export const isRealMessage = (message, _meId) => {
